...
export class Navigation extends Component {
    ...
    componentDidMount() {
        const updateDimensions = () => {
            ...
            if (width < 768) this.collapsedState();
            else this.expandedState();
        };
        updateDimensions();
        $(this.refs["side-menu"]).metisMenu();
        window.addEventListener("resize", updateDimensions);
        this.componentWillUnmount = () => window.removeEventListener("resize", updateDimensions);
    }

    render() {
        const {collapsed} = this.state;
        const cssClass = collapsed ? " collapse" : "";
        return (
            <nav className="navbar navbar-default navbar-static-top" role="navigation" style={{marginBottom: 0}}>
                ...
                <ul className="nav navbar-top-links navbar-right">
                    ...
                    <li className="dropdown">
                        ...
                        <ul className="dropdown-menu dropdown-user">
                            ...
                            <li className="divider"/>
                            <li><a href="" onClick={event => this.signOutHandler(event)}><i
                                className="fa fa-sign-out fa-fw"/> SignOut</a>
                            </li>
                        </ul>
                        {/*<!-- /.dropdown-user -->*/}
                    </li>
                ...
                <div className="navbar-default sidebar" role="navigation">
                    <div className={"sidebar-nav navbar-collapse" + cssClass}>
                        <ul ref="side-menu" className="nav side-menu">
